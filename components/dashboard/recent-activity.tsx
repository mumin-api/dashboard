    ...
    return (
        <IslamicCard>
            <div className="p-6">
                ...
                {error && (
                    <p className="text-center py-8 text-sm" style={{ color: 'rgba(255,255,255,0.45)' }}>
                        {t('failed')}
                    </p>
                )}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-accent truncate" style={{ color: 'rgba(255,255,255,0.95)' }}>
                                    ...
                                    <span className="text-sm font-display font-bold flex-shrink-0"
                                        style={{ color: isPositive ? '#34d399' : 'rgba(255,255,255,0.6)' }}>
                ...
                {!loading && !error && (
                    <Link href="/billing" className="block w-full mt-4 text-center py-2 text-xs font-accent uppercase tracking-widest transition-colors"
                        ...
                        onMouseLeave={(e: React.MouseEvent) => (e.currentTarget as HTMLElement).style.color = 'rgba(52,211,153,0.8)'}>
                        {t('viewAllFull')}
                    </Link>
                )}
            </div>
